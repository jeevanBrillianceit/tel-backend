      ...
      jsonResponse.errorHandler(res, next, err, statusCode);
        ...
        try {
           ...
           const obj = {
            ...
            const client = new ApiVideoClient({ apiKey: "Ta7oycL3SCj1qJZEZF9B60uuO3M6NFP676J496wNPfV" });
            await new Promise(async (resolve, reject) => {
            ...
            const video = await client.videos.create(videoCreationPayload);
                ...
                const videoUploadResponse = await client.videos.upload(video.videoId ,tempFileName);

                // console.log(videoUploadResponse.assets)
                const obj = {
